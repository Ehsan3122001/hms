...
<head>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-1 col-md-2  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HMS
                       <a data-toggle="collapse" data-target="#menu" href="#menu" ><i class="fas d-block d-md-none small-menu fa-bars"></i></a>
                    </div>
                    <div id="menu" class="col-lg-9 col-md-10 d-none d-md-block nav-item">
                        <ul>
                            <li><a href="#">Home</a></li>
  ...
  <!--  ************************* Logins ************************** -->
    ...
    <section id="about_us" class="about-us container">
        <div class="row no-margin">
            <div class="col-sm-5 image-bg" style="background-repeat: no-repeat; align-items:center; ">
                
            </div>
            <div class="col-sm-7 abut-yoiu " style="padding: 0 0 0 20px">
